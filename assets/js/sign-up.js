document.addEventListener('DOMContentLoaded', function() {
    ...
    const passwordInputClick = document.getElementById('passwordInputClick');
    ...
    togglePassword.addEventListener('click', function() {
        ...
        if (isPasswordVisible) {
            passwordInputClick.setAttribute('type', 'text');
        } else {
            passwordInputClick.setAttribute('type', 'password');
        }

        // Optionally, change the icon based on the current state
        // You may want to change the SVG path or classes here to indicate the visibility state
        // For example, use an open eye or closed eye icon
        if (isPasswordVisible) {
            // Update the SVG path for the open eye
        ...
        `;
            ...
            // Update the SVG path for the closed eye
            togglePassword.innerHTML = `
